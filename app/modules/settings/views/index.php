                                                    ...
                                                    <div id="collapseThree_blacklists" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree_blacklists" aria-expanded="true">
                                                        ...
                                                        <div class="panel-body row mb0">
                                                            <div class="vttags blacklist-keywords">
                                                                <label style="padding-right: 1.5em;">
                                                                    <i  aria-hidden="true"></i> <?=l('Keywords blacklist')?> <span class="help-tip" data-html="true" data-toggle="popover" data-placement="top" data-trigger="hover" title="" data-original-title="<?=l('Message')?>" data-content="<?=l("
                                                                    Add some keywords to this list that you don't want to interact with. This filter will search for stop keywords in media (tags and caption) and in user (username, full name, bio and website), and will prevent Instagress from interacting with unwanted content.<br/><br/> You can also use asterisk symbol <b>*</b> in your keywords. This will allow covering all possible variations of some keywords. For example: add <b>playboy*</b> keyword to exclude all content that contains any words that start with <b>playboy</b>.<br/><br/> You can add up to 3000 keywords in this list.
                                                                  ")?>">?</span>
                                                                </label>
                                                                    <?php
