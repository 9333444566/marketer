            ...
            <div class="card">
                <div class="header">
                    <h2 style="font-weight:700;">
                        <i class="fa fa-instagram" aria-hidden="true"></i> مدیریت اکانت های اینستاگرام متصل به پنل اتوماسیون
                    </h2>
                </div>
                <div class="header">
...
<div class="col-md-12">
	<div class="col-md-4">
		<img class="img-responsive" src="/assets/images/how-to-create-instagram-account.jpg">
	</div>
	<div class="col-md-4">
		<img class="img-responsive" src="/assets/images/verify-email-and-phone.jpg">
	</div>
	<div class="col-md-4">
		<img class="img-responsive" src="/assets/images/forget-password.jpg">
	</div>
</div>
<!-- LEARNING SYSTEM -->
	<script>
